...
class TravelPointApiServiceTest {
    ...
    @Test
    void test_retrieveTravelPointsFromApiService_with_boxToken_requestTokenHandler_exceptionHandler_and_apiService_returns_json_travelPoints() {
    ...
    @Test
    void test_retrieveTravelPointsFromApiService_with_boxToken_requestTokenHandler_exceptionHandler_and_apiService_is_executed_correctly() {
        ...
        ApiToken boxServiceApiToken = getBoxServiceApiToken();

        classUnderTest.retrieveTravelPointsFromApiService(boxServiceApiToken).collectList().block();

        InOrder inOrder = inOrder(requestTokenHandlerService, peliasApiService, exceptionHandlerService);
        inOrder.verify(requestTokenHandlerService, times(1)).getRequestApiTokenWith(boxServiceTokenArg.capture(), configuredTokenArg.capture());
        ...
        assertThat(boxServiceTokenArg.getValue()).isEqualToComparingFieldByField(getBoxServiceApiToken());
    ...
    @Test
    void test_retrieveTravelPointsFromApiService_with_boxToken_and_thrown_exception_returns_zero_travelPoints() {
        ApiToken boxServiceApiToken = getBoxServiceApiToken();
        when(requestTokenHandlerService.getRequestApiTokenWith(any(ApiToken.class), any(ApiToken.class)))
                .thenThrow(new NullPointerException());

        Flux<TravelPoint> result = classUnderTest.retrieveTravelPointsFromApiService(boxServiceApiToken);
    ...
    @Test
    void test_retrieveTravelPointsFromApiService_with_boxToken_and_error_returns_zero_travelPoints_when_apiService_failed() {
        ApiToken boxServiceTestToken = getBoxServiceApiToken();
        when(peliasApiService.extractTravelPointsFrom(any(ApiToken.class)))
                .thenReturn(Flux.error(new Exception()));

        Flux<TravelPoint> result = classUnderTest.retrieveTravelPointsFromApiService(boxServiceTestToken);
    ...
    @Test
    void test_retrieveTravelPointsFromApiService_with_boxToken_and_error_call_status_returns_zero_travelPoints_when_apiService_failed() {
        ApiToken boxServiceTestToken = getBoxServiceApiToken();
        when(peliasApiService.extractTravelPointsFrom(any(ApiToken.class)))
